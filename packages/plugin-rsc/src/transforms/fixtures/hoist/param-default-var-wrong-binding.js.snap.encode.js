...
function Component() {
  ...
  const action = /* #__PURE__ */ $$register($$hoist_0_action, "<id>", "$$hoist_0_action").bind(null, __enc([y]));

  return action
}

;export async function $$hoist_0_action($$hoist_encoded, [y] = __dec($$hoist_encoded), x = y) {
    'use server'
    var y = 'body shadow'
    return x
  };
